...
function CreateProduct() {
  ...
  const onSubmit = (data) => {
    /*const {name, stock, price, description, sale, category} = data
    dispatch(createProduct(name, stock, price, description, sale, category))
      .then(data => {
        history.push("/home");
        console.log(data);
      })
  ...
  return <div className='createProductPage'>
    <Formik initialValues={initialProductValues} onSubmit={onSubmit} validationSchema={validationSchema}>
